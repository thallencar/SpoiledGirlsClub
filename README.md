...
<!--ROUPAS E CARRINHO/><!-->
[Roupas](#listar-roupas)
 <!--PEDIDO/><!-->
[Pedidos](#listar-pedidos)
 <!--USUÁRIO/><!-->
[Usuários](#conectar-usuário)
...
`POST/roupa`
Cadastra uma roupa com dados enviados no corpo de requisição.
...
`POST/pedidos`
Cadastra um pedido com dados enviados no corpo de requisição.
...
`POST/usuario` 
Cadastra um usuário com dados enviados no corpo de requisição.
